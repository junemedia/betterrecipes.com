...
<div class="sidebar">
    ...
    */ ?>
    <div>
        ...
        <? for ($i = 0; $i < 5; $i++): ?>
        <li>
          <p><a href="<?=getRoute('@daily_dish_detail', array('year' => $items_sb[$i]['link'][0][0], 'month' => $items_sb[$i]['link'][0][1], 'day' => $items_sb[$i]['link'][0][2], 'slug' => $items_sb[$i]['link'][0][3]))?>" title="<?=$items_sb[$i]['title']?>"><?=$items_sb[$i]['title']?></a></p>
          <p><?= substr($items_sb[$i]['description'], 0 , 200) ?>...</p>
          <p><a href="<?=getRoute('@daily_dish_detail', array('year' => $items_sb[$i]['link'][0][0], 'month' => $items_sb[$i]['link'][0][1], 'day' => $items_sb[$i]['link'][0][2], 'slug' => $items_sb[$i]['link'][0][3]))?>" title="<?=$items_sb[$i]['title']?>">Read more</a></p>
        </li>
      <? endfor; ?>
      </ul>
    </div>
