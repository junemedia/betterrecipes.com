...
= 1.1.4 =
* Fixed bug where replying to a comment would break captcha in some browsers

= 1.1.3 =
* Fixed compatibility issue with Contact Form 7 version 3.4

= 1.1.2 =
* Bug fix

= 1.1.1 =
* CSRF protection for admin options page
