    ...
    <div class='ufo-tab-wrapper ufo-tab-top'>
      <div id='GeneralSettings' class='ufo-tabs ufo-tab ufo-active'>
        <div class='ufo-float-left ufo-width50'>
          ...
          <input type='hidden' value='var c = {};c.id = "FileFolder";c.events = {};c.events.blur = [];c.minmax={};c.minmax.msg=AppMan.resources.ValueLengthShouldBeLessThan;c.minmax.args=[];c.minmax.args.push("100");c.max="100";c.events.blur.push("minmax");c.InvalidCSSClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'/>
          ...
          <label for='FixJSLoading'>
            <input type='checkbox' id='FixJSLoading' value='<?php echo $obj->FixJSLoading;?>' <?php echo $obj->FixJSLoadingChecked;?> class='ufo-cb checkbox ufo-formvalue' style='margin-top:0;margin-bottom:0' onchange='this.value=(this.checked)?"on":"off";'/>
