          ...
          <fieldset>
            ...
            <div class='ufo-float-left ufo-width50'>
              ...
              <div>
                 ...
                 <textarea id='SubmissionSuccessText' class='textinput ufo-textarea ufo-formvalue' style='width:100%;height:290px' <?php echo $obj->SubmissionSuccessTextDisabled;?>><?php echo $obj->get('SubmissionSuccessText');?></textarea>
              </div>
            </div>
            <div class='ufo-float-right ufo-width50'>
              <div>
