...
function ajaxPaginateSearch(obj, path, page, term, pagetype, rating, category, _with, without, type) {
	//refreshAdtags();
	...
	$.post(
			path,
			{ page: page, term: term, pagetype: pagetype, rating: rating, cateory: category, _with: _with, without: without, type: type },
			function(data) {
								$(obj + ' ul li.pagination').hide();
								$(obj + ' ul').append(data);
						   }
