...
class AdminProfileForm extends BaseUserForm {
  ...
  public function configure(){
    ...
    unset($this['is_premium'], $this['onesite_id'], $this['blog_id'], $this['profile_id'], $this['display_name'], $this['subdir'], $this['email'], $this['reg_source'], $this['created_at'], $this['updated_at'], $this['source'], $this['legacy_id']);
