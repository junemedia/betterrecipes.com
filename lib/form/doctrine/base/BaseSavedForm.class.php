...
/**
 * Saved form base class.
 *
 * @method Saved getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseSavedForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('saved[%s]');
