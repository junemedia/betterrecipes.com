...
/**
 * PositionCount form base class.
 *
 * @method PositionCount getObject() Returns the current form's model object
 *
 ...
 */
abstract class BasePositionCountForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('position_count[%s]');
