...
class RecipeTable extends Doctrine_Table
{
  ...
  public static function getRecentRecipesPaginated($category_id, $page_no=1, $results_per_page=25)
  {
    ...
    $recipes->setQuery(Doctrine_Core::getTable('Recipe')->createQuery('r')->innerJoin('r.CategoryRecipe c')->where('c.category_id = ?', $category_id)->andWhere('r.is_active = ?', 1)->orderby('r.created_at DESC'));
