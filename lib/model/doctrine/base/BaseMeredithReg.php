...
Doctrine_Manager::getInstance()->bindComponent('MeredithReg', 'doctrine');

abstract class BaseMeredithReg extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('meredith_reg');
        ...
        $this->hasColumn('user_id', 'string', 50, array(
             'type' => 'string',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
        ...
        $this->hasColumn('registration_date', 'datetime', 50, array(
             'type' => 'datetime',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
        ...
        $this->hasColumn('registration_source', 'string', 20, array(
             'type' => 'string',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
        ...
        $this->hasColumn('newsletter_id', 'string', 50, array(
             'type' => 'string',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
