...
while( $row = $results->fetch_assoc() )
{
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_URL => 'http://meredith-betrec.baynote.net/baynote/guiderest?customerId=meredith&code=betrec&guide=MostPopularRecipes&resultsPerPage=6&attrFilter=' . $filter . '&attrList=*&url=' . urlencode($url) . '&v=1',
